                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="flex items-center space-x-4">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('coops.index')"
                                    :active="request()->routeIs('coops.index')">
                                    {{ __('Koperasi') }}
                                </x-dropdown-link>
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div x-data="{ openDropdown: false }" class="relative">
                <button @click="openDropdown = !openDropdown"
                    class="flex items-center w-full text-left text-gray-700 hover:bg-gray-100 px-4 py-2 rounded-md focus:outline-none focus:bg-gray-100 transition">
                ...
                <div x-show="openDropdown" @click.away="openDropdown = false"
                    class="mt-2 bg-white rounded-md shadow-lg w-full z-50">
                    <x-responsive-nav-link :href="route('coops.index')" :active="request()->routeIs('coops.index')">
                        {{ __('Koperasi') }}
                    </x-responsive-nav-link>
                    ...
                    <x-responsive-nav-link :href="route('colors.index')" :active="request()->routeIs('colors.index')">
                        {{ __('Warna') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('sizes.index')" :active="request()->routeIs('sizes.index')">
                        {{ __('Ukuran') }}
                    </x-responsive-nav-link>
